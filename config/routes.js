...
module.exports.routes = {
  ...
  */
  ...
  'get /restaurants': 'RestaurantController.list',
  ...
  /*
    MealController Routes
  */
 
 'get /meals': 'MealController.list',
 'post /meals': 'MealController.create',
 'get /meal/:id': 'MealController.view',
 'put /meal/:id': 'MealController.update',

   /*
    ReviewController Routes
  */
 
 'get /reviews': 'ReviewController.list',
 'post /reviews': 'ReviewController.create',
 'get /review/:id': 'ReviewController.view',
 'put /review/:id': 'ReviewController.update',
 ...
 'get /order/:id': 'OrderController.view',
